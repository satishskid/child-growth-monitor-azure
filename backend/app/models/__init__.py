...
from sqlalchemy import Column, String, DateTime, Boolean, Text, Integer, Float, JSON, ForeignKey, Enum
...
class Consent(BaseModel):
    ...
    scan_sessions = relationship('ScanSession', back_populates='consent', lazy='dynamic')
...
class ScanSession(BaseModel):
    ...
    predictions = relationship('AnthropometricPrediction', back_populates='session', uselist=False)
