...
class VideoProcessor:
    ...
    def process_video(self, video_path: str) -> Tuple[List[np.ndarray], List[Dict]]:
        ...
        try:
            ...
            logger.info(f"Processing video: {fps:.1f}fps, {total_frames} frames, {duration:.1f}s")
            ...
            logger.info(f"Processed {len(frames)} frames from {frame_count} total frames")
    ...
    def _preprocess_frame(self, frame: np.ndarray) -> Optional[np.ndarray]:
        ...
        try:
            ...
            if mean_brightness < 50 or mean_brightness > 200:
                logger.debug(f"Frame brightness {mean_brightness:.1f} may affect pose detection")
    ...
    def validate_video_quality(self, video_path: str) -> Dict:
        ...
        try:
            ...
            if duration < 5:
                ...
                recommendations.append('Keep videos under 30 seconds for faster processing')
